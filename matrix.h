...
/**
* Returns a matrix created from a string, where the string elements are separated by a space,
* and the strings are separated by a straight slash.
*/
...
/**
Returns the result of the sum of m1 and m2
*/
